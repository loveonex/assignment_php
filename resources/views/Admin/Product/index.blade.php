                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="{{ route('route_Backend_Products_Add') }}" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Add new</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th class="text-center">Description_short</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ number_format($l->price) }} VNĐ</td>
                                <td class="text-center">{{$l->description_short}}</td>
                                <td class="text-center"><a href="" class="btn btn-{{ $l->status == 0 ? 'success' : 'danger' }}">{{ $l->status == 0 ? 'Hidden' : 'Active' }}</a></td>
                                <td>
                                    <a href="" class="btn btn-primary">Edit</a>
                                    <a href="" onclick="return confirm('Bạn có chắn chắn muốn xóa sản phẩm {{ $l->name }} không ?')" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            @endforeach
